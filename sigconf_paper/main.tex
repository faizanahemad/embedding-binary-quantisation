...
\ccsdesc[100]{Applied computing~Document searching}

%%
%% Keywords. The author(s) should pick words that accurately describe
%% the work being presented. Separate the keywords with commas.
\keywords{embedding compression, matryoshka representation learning, quantization, information retrieval, hierarchical embeddings}
